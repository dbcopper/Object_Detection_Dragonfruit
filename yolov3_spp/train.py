...
def train(hyp):
    ...
    accumulate = max(round(64 / batch_size), 1)                                         # 每训练64次更新一次权重参数
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov3-spp-ultralytics-416',
                        help='initial weights path')                                                    # 如果想继续训练的话，可以把这个权重地址改为最后一次的训练的权重
